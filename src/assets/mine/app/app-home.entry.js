...
import { a as matchPath, b as isModifiedEvent, c as ActiveRouter } from './chunk-51743fa8.js';
...
class AppHome {
    render() {
        return (h("div", { class: 'app-home' },
            h("p", null,
                "Welcome to the Stencil UI library. You can use this this library to upload the files!",
                h("br", null),
                " Go to the uploader page for uploading and you can watch tht background upload progress in the console."),
            h("stencil-route-link", { url: '/profile/stencil' },
                h("button", null, "Profile page")),
            h("stencil-route-link", { url: '/root' },
                h("button", null, "Uploader page"))));
    }
